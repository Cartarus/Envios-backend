// infrastructure/http/routes/quote.routes.ts
...
router.post("/rate", authenticateToken, validateSchema(getRateSchema), async (req, res, next) => rateController.getQuote(req, res, next));
